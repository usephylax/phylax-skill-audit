...
x402 collects USDC; the handler proxies to Vercel with `PHYLAX_INTERNAL_AUDIT_KEY` (rules + Base RPC stay on the hosted engine — Bankr sandbox cannot bundle `rules/`). See [`x402/README.md`](./x402/README.md).
