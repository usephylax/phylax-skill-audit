    ...
    <section id="token" className="section-pad">
      <div className="page-container max-w-xl">
        <SectionHeader
          ...
          title={
            <>
              ${TOKEN.symbol} is live on <span className="text-accent">Robinhood Chain</span>
            </>
          }
          description="Only the contract below is official $PHYLAX. Verify the address before you trade — anything else is not us."
        />
        ...
        <m.div {...stagger(0)} className="card-surface card-interactive p-5 sm:p-6">
          ...
          <p className="section-eyebrow !text-text-muted !normal-case !tracking-wide mb-2">
            Contract address · via {TOKEN.launchpad}
          </p>
